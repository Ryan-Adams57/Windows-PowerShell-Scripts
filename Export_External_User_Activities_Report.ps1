<#
=============================================================================================
Name:           Export Office 365 External User Activities Report
...
else
{
 ...
 if((Test-Path -Path $OutputCSV) -eq "True") 
 {
  ...
  Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "GitHub - https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more Microsoft 365 reporting tools. ~~" -ForegroundColor Green `n`n
