...
4.This script automatically installs Exchange Online PowerShell Module upon your confirmation  
   ...
   For execution steps and usecases: https://www.governmentcontrol.net/
#>
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to 1800+ Microsoft 365 reports. ~~" -ForegroundColor Green `n`n
