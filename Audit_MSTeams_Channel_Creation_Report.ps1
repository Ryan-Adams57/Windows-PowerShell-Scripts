...
11.Finds standard channels creations alone.    
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://www.governmentcontrol.net/" -ForegroundColor Yellow -NoNewline; Write-Host " for additional Microsoft 365 audit resources. ~~" -ForegroundColor Green `n`n
