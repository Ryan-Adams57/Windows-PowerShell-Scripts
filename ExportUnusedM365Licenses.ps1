<#
=============================================================================================
Name:           Export Unused Licenses in Microsoft 365 Using PowerShell
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more projects and updates. ~~" -ForegroundColor Green `n`n
