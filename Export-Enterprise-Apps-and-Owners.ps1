...
Get-MgServicePrincipal -All | foreach {
 ...
 Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to more Microsoft 365 scripts. ~~" -ForegroundColor Green `n`n
