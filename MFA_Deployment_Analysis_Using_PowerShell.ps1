...
5. Automatically installs the missing required Microsoft Graph module with your confirmation.
...
if((Test-Path -Path $FilePath) -eq "True")
{
    ...
    Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more scripts and tools. ~~" -ForegroundColor Green `n
