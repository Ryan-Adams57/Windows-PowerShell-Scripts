...
5. Find Entra app permissions granted through user consent and admin consent. 
...
Write-Host "`nRetrieving the Enterprise applications with admin consents and user consents"
$AppCount = 0 
$PrintCount = 0
