<#
=============================================================================================
Name:           Export distribution groups report
Version:        1.0
...
Function main()
{
 ...
 if((Test-Path -Path $ExportCSV) -eq "True")
 {
  ...
  Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more scripts. ~~" -ForegroundColor Green `n`n 
