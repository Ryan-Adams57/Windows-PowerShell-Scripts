...
#Retrieving Audit log for the past 180 days if dates not specified
...
$OutputCSV="$Location\File_Download_Audit_Report_$((Get-Date -format yyyy-MMM-dd-ddd` hh-mm` tt).ToString()).csv" 
