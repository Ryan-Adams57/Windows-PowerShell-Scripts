...
if((Test-Path -Path $ExportCSV) -eq "True") 
{
    ...
    Write-Host "`nFor more Microsoft 365 PowerShell scripts, visit: https://www.governmentcontrol.net"
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to more Microsoft 365 reports. ~~" -ForegroundColor Green `n`n
