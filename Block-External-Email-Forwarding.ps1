...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more details and scripts. ~~" -ForegroundColor Green `n`n
