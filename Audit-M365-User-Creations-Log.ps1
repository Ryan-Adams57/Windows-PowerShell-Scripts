...
#Audit mailbox permission changes for the past 90 days
...
While($true)
{
 ...
 Try
 {
  ...
  {
   Write-Host `nAudit can be retrieved only for the past 90 days. Please select a date after $MaxStartDate -ForegroundColor Red
   return
  }
 }
 Catch
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "GitHub - https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more scripts. ~~" -ForegroundColor Green `n`n
