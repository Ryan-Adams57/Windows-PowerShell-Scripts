...
while($true) {
    ...
    if(($CurrentResultCount -eq 50000) -or ($Results.count -lt 5000)) {
        ...
        #Break loop if start date exceeds current date
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://www.governmentcontrol.net/" -ForegroundColor Yellow -NoNewline; Write-Host " for additional resources. ~~" -ForegroundColor Green 
