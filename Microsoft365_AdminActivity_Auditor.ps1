...
Version:        1.0
Website:        GitHub - https://github.com/Ryan-Adams57
...
5. Allows you to generate an admin activity report for a custom period.  
...
else
{
 ...
 if((Test-Path -Path $OutputCSV) -eq "True") 
 {
  ...
  Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://pastebin.com/u/Removed_Content" -ForegroundColor Yellow -NoNewline; Write-Host " for additional Microsoft 365 audit scripts. ~~" -ForegroundColor Green `n`n
