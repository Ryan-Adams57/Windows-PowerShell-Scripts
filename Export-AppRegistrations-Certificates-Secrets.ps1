<#
=============================================================================================
Name:           Export App Registrations, Client Secrets, & Certificates
Description:    The script exports all app registrations and their client secrets & certificates along with the expiry status, expiry date, etc.
Version:        1.0
...
7. Allows exporting the list of apps soon to expire client secrets and certificates (i.e., 30 days, 90 days, etc.). 
...
Get-MgApplication -All -Property $RequiredProperties | foreach {
 ...
 Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more tools and scripts. ~~" -ForegroundColor Green `n
