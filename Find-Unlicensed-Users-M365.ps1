...
if((Test-Path -Path $ExportCSV) -eq "True")
{
    ...
    Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "governmentcontrol.net" -ForegroundColor Yellow -NoNewline; Write-Host " for more information. ~~" -ForegroundColor Green `n`n
