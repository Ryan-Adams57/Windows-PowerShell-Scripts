<#
=============================================================================================
Name:           Audit Microsoft 365 User Creations
Version:        1.0
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "GitHub: https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " for more projects. ~~" -ForegroundColor Green `n`n
