...
# This function checks the user choice and gets the guest user data
Function FindGuestUsers {
    ...
    if ($SiteWiseGuest.IsPresent) {
        ...
        Get-SPOSite | foreach-object {
            ...
            # Filters the sites with guest users
    ...
    # Checks the guest user account creation within the mentioned days and retrieves it
