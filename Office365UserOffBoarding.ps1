<#
=============================================================================================
Name:           Automate Office 365 User Offboarding with PowerShell
Description:    This script can perform Office 365 offboarding activities.
Version:        1.0

Change Log
~~~~~~~~~~

V1.0 (Oct 14, 2025) - File created
V2.0 (Apr 02, 2026)
