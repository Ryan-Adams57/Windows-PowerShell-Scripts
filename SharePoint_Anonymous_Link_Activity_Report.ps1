...
Script Highlights: 
~~~~~~~~~~~~~~~~~
1. Allows generating 8 different anonymous link reports. 
...
#Getting anonymous activity for the past 90 days
...
while($true)
{ 
 #Getting anonymous sharing/access audit data for the given time range
