...
#Display Details about successful and failure 
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/Ryan-Adams57" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to more resources. ~~" -ForegroundColor Green `n`n
}  
